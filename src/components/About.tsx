...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 relative z-10 border-t border-[rgba(200,61,74,0.15)] bg-[#100406]/70 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 space-y-12">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-[#f7e9e1] leading-relaxed font-body"
          >
          ...
          <motion.p
            ...
            className="text-xs sm:text-base text-[#f7e9e1]/80 leading-relaxed font-body max-w-3xl mx-auto"
          >
        ...
        <div className="space-y-6 pt-2">
          <div className="text-center space-y-1">
            <h3 className="font-display font-black text-xl sm:text-2xl text-[#f7e9e1] uppercase tracking-wider">
              I WORK WITH
            </h3>
            <p className="text-[11px] font-grotesk font-bold text-[#c83d4a] uppercase tracking-widest">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3.5 max-w-5xl mx-auto">
            {skillsList.map((skill, idx) => (
              <motion.div
                ...
                className="reference-card p-4 flex flex-col items-center justify-center text-center space-y-2 group cursor-default"
              >
                <div className="p-2.5 rounded-xl bg-[#120608] border border-[rgba(200,61,74,0.3)] group-hover:border-[#c83d4a] transition-colors shadow-inner">
                  {skill.icon}
                </div>
                <span className="font-display font-extrabold text-xs text-[#f7e9e1] uppercase tracking-wider group-hover:text-[#c83d4a] transition-colors">
                  {skill.name}
                </span>
              </motion.div>
            ))}
