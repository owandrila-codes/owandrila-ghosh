      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 space-y-12">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <motion.p
            ...
            className="text-xs sm:text-base text-[#f7e9e1]/80 leading-relaxed font-body max-w-2xl mx-auto"
          >
        ...
        <div className="space-y-5 pt-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 max-w-4xl mx-auto">
            {skillsList.map((skill, idx) => (
              ...
              >
                <div className="p-2.5 rounded-xl bg-[#120608] border border-[rgba(200,61,74,0.3)] shadow-inner">
                  {skill.icon}
                </div>
                <span className="font-display font-extrabold text-xs text-[#f7e9e1] uppercase tracking-wider">
                  {skill.name}
                </span>
              </motion.div>
            ))}
