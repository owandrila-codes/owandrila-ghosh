...
export default function RoseWebGLCanvas({ stage, progress }: RoseWebGLCanvasProps) {
  ...
  // Sync refs so the single animation loop always has fresh values
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Read current progress from ref
      ...
      // --- STAGE 04 (Petal Disintegrates 65% to 90%) ---
      ...
      // --- STAGE 05 (Magic Fades 88% to 100%) ---
